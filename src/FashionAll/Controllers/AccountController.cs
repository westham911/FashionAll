...
using FashionAll.Models.AccountViewModels;
using FashionAll.Services;
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    await _userManager.AddToRoleAsync(user, "Member"); //each newly Registered user is added as a ‘Member’.
